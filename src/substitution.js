...
const substitutionModule = (function () {
  ...
  function substitution(input, alphabet, encode = true) {
    ...
    const uniqueAlpha = subAlphabet.filter( //no repeated letters/characters in given alphabet
    ...
    const newEncoded = () => {
      ...
      inputArray.forEach((lett) => {
       lett === " " ? message.push(" ") : encode(lett);   // keeps space or encodes letter/character
      });
    ...
    const decodedMess = () => {
      ...
      inputArray.forEach((lett) => {
        lett === " " ? message.push(" ") : decode(lett);// keeps space or decodes letter/character
      });
      return message.join(""); //join array into a string
    ;
  }
